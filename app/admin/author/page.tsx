  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-800">Author</h1>
          <p className="text-gray-500 mt-1">Manage author information</p>
        </div>
        <Link
      ...
      <div className="space-y-4">
        {loading ? (
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 text-center text-gray-500">
            No entries found. Add author information.
          </div>
        ) : (
          items.map((item) => (
            <div key={item._id} className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  <Link
                    href={`/admin/author/${item._id}/edit`}
