  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-800">Add Author</h1>
          <p className="text-gray-500 mt-1">Create author content with HTML</p>
        </div>
      </div>
