...
export default function NewInterpretationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        setError(data.error || 'Failed to create interpretation');
        return;
      }
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-800">Add Interpretation</h1>
          <p className="text-gray-500 mt-1">Create a new verse interpretation</p>
        </div>
      </div>
