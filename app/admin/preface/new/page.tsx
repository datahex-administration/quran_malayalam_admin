...
export default function NewPrefacePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) { setError(data.error || 'Failed to create preface'); return; }
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-800">Add New Preface</h1>
          <p className="text-gray-500 mt-1">Create a new preface entry</p>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
              placeholder="Enter preface subtitle"
              required
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Enter preface text"
              required
            />
          </div>
